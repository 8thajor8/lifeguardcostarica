    ...
    <table class="listados">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $reporte->patient_name . " " . $reporte->patient_lastname1 ?></td>
                <td><?php echo $reporte->date_report ?></td>
                <td><?php echo $reporte->time_report ?></td>
        ...
        <div class="modal-content">
            ...
            <form  class="formulario_modal" method="POST" enctype="multipart/form-data">
                ...
                <div class=" campo_modal">
                    ...
                    <p>Usted esta subiendo el reporte firmado para:  <span class="paciente_notas"> <?php echo $reporte->patient_name . ' ' . $reporte->patient_lastname1 ?></span></p>
